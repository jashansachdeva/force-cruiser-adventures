...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "NomadCruiser" },
      { property: "og:title", content: "NomadCruiser — Force Cruiser & Travel Rentals" },
      { property: "og:description", content: "Premium Force Cruiser and travel vehicle rentals for short getaways and long expeditions across India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@NomadCruiser" },
    ],
    links: [
